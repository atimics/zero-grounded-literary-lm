...
all: reasoner0 reasoner1 reasoner2 reasoner3 reasoner31 reasoner32 reasoner33 reasoner34_witness

.PHONY: reasoner0-check reasoner1-check reasoner2-check reasoner3-check \
	reasoner31-check reasoner32-check reasoner33-check reasoner34-witness-check
