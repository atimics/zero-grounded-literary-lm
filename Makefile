...
.PHONY: all check clean web channel-data zero3-data zero3-stage1 \
	...
	zero5-cpu-speed-check zero5-tensor-batch-check zero5-tensor-aws-check \
...
check: sero-series-closure-check zero5-c0-check zero5-c1-check zero5-c2-check zero5-c3-check zero5-c31-check zero5-c32-check zero5-c33-check zero5-c33-parallel-check zero5-c33-parallel-result-check zero5-tensor-batch-check zero5-tensor-aws-check zero5-tensor-aws-result-check
