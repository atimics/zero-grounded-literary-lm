            ...
            for (uint32_t repeat = 0u; repeat < R56_DEVELOPMENT_REPEATS;
                ...
                for (uint32_t arm_index = 0u;
                    ...
                    if (r56_append(line, sizeof(line), &length,
                        ...
                        "\"probability_sum\":%.15g,\"truth_rank\":%u,"
                        "\"top_one_truth\":%s,\"truth_probability\":%.15g,"
                        "\"normalized_log_loss\":%.15g,\"brier\":%.15g,"
...
int r56_write_development_result(const char *path,
    ...
    if (fprintf(file,
        ...
        "  \"target_only_median_cost\": %.15g,\n"
        "  \"full_mean_normalized_log_loss\": %.15g,\n"
        "  \"full_mean_brier\": %.15g,\n"
        "  \"development_classes\": [",
