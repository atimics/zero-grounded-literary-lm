...
const TEMPLATE = "benchmarks/zero4-q31-v1/pilot-budget.json";
...
export function materialize(template, options, contractSha256) {
  ...
  assert.match(options["approval-id"], /^q31-[a-z0-9-]+$/);
  ...
  runtime.authorization = {
    ...
    public_quantity_authorized: false,
...
function selfTest() {
  ...
  console.log("Q3.1 runtime budget materializer self-test passed");
}
...
function main() {
  ...
  console.log(`wrote one-shot Q3.1 runtime budget to ${options.out}`);
}
