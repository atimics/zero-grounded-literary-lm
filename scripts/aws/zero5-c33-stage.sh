...
contract_sha256=$(digest_file benchmarks/zero5-c33-v1/contract.json)
...
source_key="experiments/zero5-c33-v1/inputs/source-${source_commit}-${source_sha256}.tar.gz"
asset_key="experiments/zero5-c33-v1/inputs/assets-${asset_sha256}.tar.gz"
...
jq -n --arg source_commit "$source_commit" \
  ...
  '{schema:"zero.c33_aws_stage.v1",source_commit:$source_commit,
