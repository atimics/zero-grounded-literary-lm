...
source_commit=8153537581137822a1fa5e3c98139c60238ba8d4
expected_sha256=33fd19521ff5cc7f30bbca81bbb47428fd5118dc5020db068b15a74472fcc733
expected_bytes=54787
source_files=(
  Makefile
  reasoner0.c
  reasoner0.h
...
if [ "$action" = dry-run ]; then
  jq -n --arg source_commit "$source_commit" \
    ...
    '{schema:"zero.reasoner41_aws_stage.v1",action:"dry-run",
...
jq -n --arg source_commit "$source_commit" \
  ...
  '{schema:"zero.reasoner41_aws_stage.v1",action:"stage",
    source_commit:$source_commit,source_sha256:$source_sha256,
    source_bytes:$source_bytes,destination:$destination,
