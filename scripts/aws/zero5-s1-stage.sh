...
contract_sha256=$(digest_file benchmarks/zero5-s1-scale-v1/contract.json)
required=(
  ...
  build/zero5-c43-v1/import-final/train.primary.grouped.z5pack
...
node scripts/run_zero5_s1_scale.mjs \
  ...
  --out "$ZERO5_ASSET_ROOT/build/zero5-s1-scale-v1/stage-check" \
...
prefix=experiments/zero5-s1-scale-v1/inputs
