...
contract_sha256=$(digest_file benchmarks/zero5-c61-shared-state-v1/contract.json)
required=(
  ...
  build/zero5-c43-v1/import-final/frozen-validation/validation.z5pack
  build/zero5-c61-shared-state-v1/control/matched-control-result.json
)
...
node scripts/run_zero5_c61_shared_state.mjs \
  ...
  --target-import "$ZERO5_ASSET_ROOT/build/zero5-c52-targets/import-final" \
  --c51-import "$ZERO5_ASSET_ROOT/build/zero5-c51-v1/import-final" \
  --c43-import "$ZERO5_ASSET_ROOT/build/zero5-c43-v1/import-final" \
  ...
  --control-result "$ZERO5_ASSET_ROOT/build/zero5-c61-shared-state-v1/control/matched-control-result.json" \
...
prefix=experiments/zero5-c61-shared-state-v1/inputs
